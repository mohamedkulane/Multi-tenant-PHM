...
The app uses a small pathname router in `apps/web/src/application.tsx`. Tenant pages render inside `TenantShell` and platform pages inside `PlatformShell`.
...
- `/audit` -> TenantAuditPage
- `/account` -> AccountPage

## Platform routes

- `/platform/login` -> PlatformLoginPage
- `/platform/dashboard` -> PlatformOverviewPage
- `/platform/tenants` -> PlatformTenantsPage
- `/platform/plans` -> PlatformPlansPage
- `/platform/administrators` -> PlatformAdministratorsPage
- `/platform/notifications` -> PlatformBroadcastsPage
- `/platform/support` -> PlatformSupportPage
