...
describe("tenant role permissions", () => {
  ...
  it.each<[TenantRole, Permission, boolean]>([
    ...
    ["PHARMACIST", "supplier.read", true],
    ["PHARMACIST", "supplier.manage", false],
    ["DOCTOR", "supplier.read", false],
    ["RECEPTIONIST", "supplier.read", false],
    ["LAB_TECHNICIAN", "supplier.read", false],
