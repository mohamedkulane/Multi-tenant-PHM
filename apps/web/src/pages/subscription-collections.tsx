...
export function SubscriptionCollections() {
  ...
  return (
    <Card
      title="Monthly subscription collections"
      className="mt-6"
          ...
          <>
            <div className="my-5 grid gap-4 sm:grid-cols-2">
              ...
              <Stat
                ...
                value={selected?.paymentCount ?? 0}
                tone="blue"
                detail="All recorded payments, including multiple payments by the same tenant"
              />
            </div>
